...
module.exports = function(app) {
    ...
    app.get('/api/users/:id', auth.requiresRole('admin'), users.getUserById); //display individual user, only for admin
    app.post('/api/users', users.createUser); //new user route
    app.put('/api/users/:id', auth.requiresRole('admin'), users.updateUserById);
